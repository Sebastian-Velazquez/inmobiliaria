...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="{{route('/')}}">Home</a> / Agentes</span>
    <h2>Agentes</h2>
</div>
</div>
<!-- banner -->
...
<div class="row">
  <div class="col-lg-8  col-lg-offset-2 col-sm-12">
      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-sm-7 "><h4>Marisol Flores</h4><p>Collaboratively administrate empowered markets via plug-and-play networks. Dynamically procrastinate B2C users after installed base benefits. Dramatically visualize customer directed convergence without revolutionary ROI.</p></div>
        <div class="col-lg-3 col-sm-3 "><span class="glyphicon glyphicon-envelope"></span> <a href="mailto:abc@realestate.com" style="color:#a94b77">abc@realestete.com</a><br>
